...
class MateCreateDepartmentWizard(models.TransientModel):
    _name = 'his.create.department.wizard'
    ...
    department_ids = fields.One2many(
        'his.create.department.line.wizard',
    ...
    def save_department(self):
        ...
        return self.env.ref('his_health_check.his_health_check_department_action').read()[0]

    @api.model
    def action_create_department(self):
        """Create a new department with the given parameters."""
        action = self.env.ref('his_health_check.action_mate_create_department_wizard').read()[0]
        action['context'] = {
...
class MateCreateDepartmentLineWizard(models.TransientModel):
    _name = 'his.create.department.line.wizard'

    department_wizard_id = fields.Many2one(
        'his.create.department.wizard',
        string='Department',
