...
class MatePatient(models.Model):
    ...
    _inherit = ['mail.thread', 'format.gov.code.label.mixin', 'mail.activity.mixin', 'his.mixin', 'clinic.document.mixin']
    _inherits = {
    ...
    clinic_tag_ids = fields.Many2many('his.patient.tag', 'patient_tag_his_rel', 'tag_id', 'patient_tag_id', string="HIS Tags")
