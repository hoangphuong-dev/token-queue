...
class Flavour(models.Model):
    ...
    _sql_constraints = [
        ('name_clinic_medi_flavour_uniq', 'unique (name)', 'The name of the Content must be unique !'),
    ]
...
class MateActiveComp(models.Model):
    ...
    amount = fields.Float(string='Amount of component',
                          help='Amount of component used in the drug (eg, 250 mg) per dose')
