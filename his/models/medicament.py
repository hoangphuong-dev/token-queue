...
class MateMedicamentGroup(models.Model):
    ...
    physician_id = fields.Many2one(HIS_PHYSICIAN, ondelete='set null', string='Physician')
    diseases_id = fields.Many2one('his.diseases', ondelete='set null', string='Diseases')
