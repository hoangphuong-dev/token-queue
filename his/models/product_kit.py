...
class MateMedicamentGroup(models.Model):
    ...
    clinic_kit_line_ids = fields.One2many('clinic.product.kit.line', 'clinic_kit_id', string='Kit lines')
    description = fields.Text("Description")


class MateProductKitLine(models.Model):
    _name = 'clinic.product.kit.line'
    _order = 'sequence asc'
...
class ProductTemplate(models.Model):
    ...
    clinic_kit_line_ids = fields.One2many('clinic.product.kit.line', 'product_template_id', string='Kit Components')
    ...
    clinic_medical_alert_ids = fields.Many2many('clinic.medical.alert', 'clinic_product_medical_alert_rel','product_id', 'alert_id',
        string='Medical Alerts')
    clinic_allergy_ids = fields.Many2many('clinic.medical.allergy', 'clinic_product_allergies_rel','product_id', 'allergies_id',
        string='Allergies')
